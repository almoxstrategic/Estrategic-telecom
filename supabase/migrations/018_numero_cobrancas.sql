-- Rastreamento de cobranças WhatsApp por WO

alter table public.wos_cabecalho
  add column if not exists numero_cobrancas integer not null default 0;

comment on column public.wos_cabecalho.numero_cobrancas is
  'Quantidade de cobranças WhatsApp enviadas para esta WO.';
